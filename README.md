...
```mermaid
graph TD
    A[Python Script<br>Fetch Bitcoin Price<br>via CoinGecko API] --> B[Write Data to CSV]
    B --> C[Push CSV Files to GitHub]
    C --> D[Qlik Sense REST Connector<br>Pull Latest CSV from GitHub]
    D --> E[Qlik Sense Dashboard<br>Visualize & Analyze Data]
    E --> F[User Exploration<br>Filtering, Analytics,<br>Interactive Charts]
